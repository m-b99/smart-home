...
//            FirebaseMessaging.getInstance().addOnSuccessListener(this, new OnSuccessListener<FirebaseInstallations>() {
//                @Override
//                public void onSuccess(FirebaseMessaging instanceIdResult) {
//                    final String newToken = instanceIdResult.toString();
