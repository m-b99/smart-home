                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            user.sendEmailVerification();
                            DynamicToast.makeSuccess(RegistrationActivity.this, "Please Verify Your Email", 10).show();
                            FirebaseAuth.getInstance().signOut();
                            startActivity(new Intent(RegistrationActivity.this, LoginActivity.class));
                            finish();
                        }
                        ...
                        {
                            FirebaseAuth.getInstance().signOut();
                            DynamicToast.makeError(RegistrationActivity.this, "Error occured", 10).show();
                            startActivity(new Intent(RegistrationActivity.this, RegistrationActivity.class));
                            finish();
                        }
                    }
